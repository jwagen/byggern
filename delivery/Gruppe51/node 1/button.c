...
//Sets the direction and pullup on putton inputs
...
//Returns 1 if the specified button is pressed
...
//Returns if the specified putton is HIGH, LOW, RISING, FALLING. 
//It has to be called at least two times to return eighter RISING or FALLING.
