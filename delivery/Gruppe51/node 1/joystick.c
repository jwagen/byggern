...
//Initialze the systems needed by the joystic
void joystick_init(void){
	adc_init();
	
}

//Reads the joysick value, and stores it in a struct.
//The values range from -128 to 127. Where 0 is the middle position.
...
//Returns a discrete direction enum. NETURAL_RANGE defines the area around the neutra joystick position where it wil return NEUTRAL.
...
//Calibration function for the joystick.
//Found to be largly unneccecary
